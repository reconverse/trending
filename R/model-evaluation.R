...
#'   [`?trending_model`](trending_model) for the different ways to build
#'   `trending_model` objects
#'
#' @param model a model specified as an `trending_model` object, as returned by
#'   `lm_model`, `glm_model`, `glm_nb_model`, `brms_model`; see
#'   [`?trending_model`](trending_model) for details
#'
